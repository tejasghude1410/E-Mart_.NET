...
public class InvoiceDetailsController : ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<Product>>> GetProductByInvoiceId(int invoiceID)
    {
        var products = await _repository.GetProductByInvoiceIdAsync(invoiceID);
